...
void main() {
  runApp(MaterialApp(
    home: ClassesWidgetCopy(),
  ));
}

class ClassesWidgetCopy extends StatefulWidget {
  const ClassesWidgetCopy({super.key});

  @override
  State<ClassesWidgetCopy> createState() => _ClassesWidgetCopyState();
}

class _ClassesWidgetCopyState extends State<ClassesWidgetCopy> {
  ...
  Future<void> getUserIdFromSharedPreferences() async {
    ...
    setState(() {
      ...
      staffAccess = prefs.getString("staffAccess");
    });
  ...
  void showUpdateDialog(BuildContext context, String classId) {
    showDialog(
      context: context,
      builder: (context) {
        return BackdropFilter(
          ...
          child: AlertDialog(
            ...
            actions: [
              ...
              TextButton(
                onPressed: () {
                  updateClass(classId, classController.text);
                  Navigator.of(context).pop();
                },
                child: Text('Update'),
              ),
...
class ClassCard extends StatelessWidget {
  ...
  final Function(BuildContext, String) showUpdateDialog;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        title: Text(" Class Name :- $teacherName"),
        trailing: PopupMenuButton<String>(
          onSelected: (value) {
            if (value == 'update') {
              // Handle update action
              showUpdateDialog(context, classData.id);
